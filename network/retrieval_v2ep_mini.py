...
train_output_path = '../data/output_mini%s/train_output.txt' % (sys.argv[1])
test_output_path = '../data/output_mini%s/test_output.txt' % (sys.argv[1])
test_label_path = '../data/test_list_mini.txt'
...
def get_test_label(filename):
    ...
    while line:
        ...
        lable_dict['../data/test_data_mini/'+line_list[0]] = line_list[1]
        line = f.readline()
    return lable_dict
