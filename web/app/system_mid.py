...
def service():
    ...
    if request.method == 'POST':
        ...
        result["rank1"] = result_[0][0].replace('../web/app', '..')
        result["rank2"] = result_[1][0].replace('../web/app', '..')
        result["rank3"] = result_[2][0].replace('../web/app', '..')
        result["rank4"] = result_[3][0].replace('../web/app', '..')
        result["rank5"] = result_[4][0].replace('../web/app', '..')
        print(result)
