...
def main():
    if os.path.exists('./result_12_mini/train_binary') and os.path.exists('./result_12_mini/train_label') and \
       os.path.exists('./result_12_mini/test_binary') and os.path.exists('./result_12_mini/test_label') and args.pretrained == 0:
        train_binary = torch.load('./result_12_mini/train_binary')
        train_label = torch.load('./result_12_mini/train_label')
        test_binary = torch.load('./result_12_mini/test_binary')
        test_label = torch.load('./result_12_mini/test_label')
        ...
        if not os.path.isdir('result_12_mini'):
            os.mkdir('result_12_mini')
        torch.save(train_binary, './result_12_mini/train_binary')
        torch.save(train_label, './result_12_mini/train_label')
        torch.save(test_binary, './result_12_mini/test_binary')
        torch.save(test_label, './result_12_mini/test_label')
